...
def load_glasser_surf():
    ...
    cmaps = {
        "left": load_freesurfer_lut("/data/projects/chess/data/misc/lh_HCPMMP1_color_table.txt")[0],
        "right": load_freesurfer_lut("/data/projects/chess/data/misc/rh_HCPMMP1_color_table.txt")[0],
        }
