...
for multiple_comparions_corr in [True, False]:
    ...
    expert_averages_df, expert_ci_lower_df, expert_ci_upper_df, expert_p_values_df = (
        calculate_stats(experts_dfs_roigroup, chance_levels=[0.0, 0.0, 0.0], multiple_comp_corr=fdr_string)
    )
    (
    ...
    ) = calculate_stats(nonexpert_dfs_roigroup, chance_levels=[0.0, 0.0, 0.0], multiple_comp_corr=fdr_string)
