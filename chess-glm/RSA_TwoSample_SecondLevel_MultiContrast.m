...
contrastFiles = { ...
    'searchlight_visualSimilarity.nii', ...
    };
...
for c = 1:numel(contrastFiles)
    ...
    secondLevelFolder = fullfile(rootDir, ['2ndLevelRSA_' contrastBase]);
...
for i = 1:numel(subjectList)
    thisFile = fullfile(rootDir, ['sub-' subjectList{i}, '_', contrastFile]);
