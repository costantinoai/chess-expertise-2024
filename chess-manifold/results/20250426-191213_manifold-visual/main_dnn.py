...
def get_spm_info(subject_id: str) -> dict:
    ...
    root = getattr(SPM, "swd", os.path.dirname(spm_mat_path))  # source directory
...
def run_manifold_for_matrix(mat_feat_x_obs: np.ndarray, n_reps: int = 1) -> dict:
    ...
    a, r, d, rho0, _ = manifold_analysis_corr(X_list, 0, n_obs, n_reps=n_reps)
...
# Define paths
acts_trained_path = "/home/eik-tb/OneDrive_andreaivan.costantino@kuleuven.be/GitHub/chess-expertise-2024/chess-dnn/results/20250419-190918_extract-net-activations-alphavile_dataset-fmri/activations_model-trained_seed-0.pkl"
acts_untrained_path = "/home/eik-tb/OneDrive_andreaivan.costantino@kuleuven.be/GitHub/chess-expertise-2024/chess-dnn/results/20250419-190918_extract-net-activations-alphavile_dataset-fmri/activations_model-untrained_seed-0.pkl"

# Load the pickled objects
with open(acts_trained_path, 'rb') as f:
    acts_trained = pickle.load(f)

with open(acts_untrained_path, 'rb') as f:
    acts_untrained = pickle.load(f)
