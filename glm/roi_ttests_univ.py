#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Group ROI stats — Univariate GLM (Experts vs Novices).

Thin IDE-runner that orchestrates ROI-level summaries for univariate contrasts.
...
if __name__ == "__main__":
    ...
    setup_logging()
    setup_logging(log_file=os.path.join(OUTPATH, "glm_roi_ttests_univ.log"))
